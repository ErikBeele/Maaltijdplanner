<div class="form">
            <form action="overzicht.php" method="POST" onsubmit="return validateForm();">
                <label for="gerecht">Kies hier tussen de 3 voorkeur Ingrediënten</label><br>
                <input type="checkbox" class="gerechtenbox" name="gerecht[]" value="vlees" id="vlees" onchange="generateIngredientInputs();">
                <label for="vlees" class="vlees">VLEES</label><br>
                <input type="checkbox" class="gerechtenbox" name="gerecht[]" value="vis" id="vis" onchange="generateIngredientInputs();">
                <label for="vis" class="vis">VIS</label><br>
                <input type="checkbox" class="gerechtenbox" name="gerecht[]" value="vegetarisch" id="vegetarisch" onchange="generateIngredientInputs();">
